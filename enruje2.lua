...
local Library = { 
    ...
    local Themes = {
        ["Preset"] = {
            ...
            ["Inline"] = Color3.fromRGB(21, 23, 28),
            ["Tab"] = Color3.fromRGB(30, 31, 38),
            ["Text"] = Color3.fromRGB(223, 225, 229),
            ["Inactive Text"] = Color3.fromRGB(116, 118, 122),
            ["Element"] = Color3.fromRGB(31, 32, 39),
            ["Section"] = Color3.fromRGB(23, 25, 29),
            ["Accent"] = Color3.fromRGB(0, 177, 162),
            ["Liner"] = Color3.fromRGB(28, 30, 34),
            ["Hovered Element"] = Color3.fromRGB(44, 46, 54),
        }
    }
    ...
    local CustomFont = { } do
        ...
        Library.Font = CustomFont:New("figtreemedium", 400, "Regular", {
            Id = "figtreemedium",
            Url = "https://github.com/sametexe001/luas/raw/refs/heads/main/fonts/Figtree-Medium.ttf"
        })

        Library.BoldFont = CustomFont:New("bubblegumsans", 400, "Regular", {
            Id = "bubblegumsans",
            Url = "https://github.com/sametexe001/luas/raw/refs/heads/main/fonts/Bubblegum-Sans.ttf"
        })
    end
    ...
    Library.MakeResizeable = function(Self, Minimum)
        if not Self.Instance or IsMobile then 
            return
        end
    ...
    Library.ScaleOffset = function(Self, Number)
        return Number / Library:GetScreenScale()
    end
    ...
    do
        Library.CreateColorpicker = function(Self, Data)
            ...
            local Items = { } do 
                ...
                Items["ColorpickerWindow"] = Library:Create("TextButton", {
                    ...
                    Text = "",
                    AutoButtonColor = false,
                    Position = UDim2.new(0, 1063, 0, 149),
                    Size = UDim2.new(0, 235, 0, 300),
                    BorderSizePixel = 0,
                ...
                Items["CloseButton"] = Library:Create("ImageButton", {
                    ...
                    Image = "rbxassetid://98207318120744",
                    BackgroundTransparency = 1,
                ...
                Items["Checkers"] = Library:Create("Frame", {
                    Name = "\0",
                    Parent = Items["Alpha"].Instance,
                    BackgroundColor3 = Color3.fromRGB(255, 255, 255),
                    Size = UDim2.new(1, 0, 1, 0),
            ...
            function Colorpicker:Update(IsFromAlpha)
                ...
                Items["HueDragger"]:Tween({BackgroundColor3 = Color3.fromHSV(Hue, 1, 1)})
                Items["AlphaDragger"]:Tween({BackgroundColor3 = Color3.fromHSV(Hue, 1, 1)})
                Items["Palette"]:Tween({BackgroundColor3 = Color3.fromHSV(Hue, 1, 1)})
                Items["Color"]:Tween({BackgroundColor3 =Colorpicker.Color})
            ...
            function Colorpicker:SetOpen(Bool)
                ...
                if Colorpicker.IsOpen then 
                    ...
                    Items["ColorpickerWindow"]:Tween({Position = Library:PopupPosition(ColorpickerButton, ColorpickerWindow, 10)})
            ...
            function Colorpicker:SlideHue(Input)
                ...
                local SlideY = math.clamp((Input.Position.Y - Items["Hue"].Instance.AbsolutePosition.Y) / Items["Hue"].Instance.AbsoluteSize.Y, 0, 0.91)
            ...
            function Colorpicker:SlideAlpha(Input)
                ...
                local SlideX = math.clamp((Input.Position.X - Items["Alpha"].Instance.AbsolutePosition.X) / Items["Alpha"].Instance.AbsoluteSize.X, 0, 0.91)
            ...
            function Colorpicker:Set(Color, Alpha)
                ...
                local AlphaPositionX = math.clamp(Colorpicker.Alpha, 0, 0.91)
                    
                local HuePositionY = math.clamp(Colorpicker.Hue, 0, 0.91)
            ...
            Items["HexInput"]:Connect("FocusLost", function()
                Colorpicker:Set(Items["HexInput"].Instance.Text, Colorpicker.Alpha)
            end)
        ...
        Library.CreateKeybind = function(Self, Data)
            ...
            local Items = { } do
                Items["SettingsButton"] = Library:Create("ImageButton", {
                    ...
                    ImageColor3 = Library.Theme["Inactive Text"],
                    AutoButtonColor = false,
                    Image = "rbxassetid://74791135866536",
                    BackgroundTransparency = 1,
                    Size = UDim2.new(0, 18, 0, 18),
                    BorderSizePixel = 0
                }):AddToTheme({ImageColor3 = 'Inactive Text'})        
                ...
                Items["KeybindWindow"] = Library:Create("TextButton", {
                    ...
                    Position = UDim2.new(0, 1048, 0, 156),
                    BorderSizePixel = 0,
                    AutomaticSize = Enum.AutomaticSize.Y,
                    BackgroundColor3 = Library.Theme["Inline"]
                }):AddToTheme({BackgroundColor3 = 'Inline'})
                ...
                Items["ToggleText"] = Library:Create("TextLabel", {
                    Name = "\0",
                    FontFace = Library.Font,
                    TextSize = Library.FontSize,
                    Parent = Items["Toggle"].Instance,
                ...
                Items["HoldText"] = Library:Create("TextLabel", {
                    Name = "\0",
                    FontFace = Library.Font,
                    TextSize = Library.FontSize,
                    Parent = Items["Hold"].Instance,
            ...
            function Keybind:SetOpen(Bool)
                ...
                if Keybind.IsOpen then 
                    ...
                    Items["KeybindWindow"]:Tween({Position = Library:PopupPosition(KeyButton, KeybindWindow, 10)})
            ...
            function Keybind:SetMode(Mode)
                ...
                if Mode == "Toggle" then --- Hard coded pooo
                    Items["Toggle"]:ChangeItemTheme({BackgroundColor3 = "Accent"})
                    Items["Toggle"]:Tween({BackgroundColor3 = Library.Theme["Accent"]})

                    Items["Hold"]:ChangeItemTheme({BackgroundColor3 = "Element"})
                    Items["Hold"]:Tween({BackgroundColor3 = Library.Theme["Element"]})
                else
                    Items["Hold"]:ChangeItemTheme({BackgroundColor3 = "Accent"})
        ...
        Library.Tooltip = function(Self, Text)
            ...
            Items["Tooltip"].Instance.Size = UDim2.new(0, 0, 0, 30)
        
            local RenderStepped
        
            Library:Connect(Object.MouseEnter, function()
                local MouseLocation = UserInputService:GetMouseLocation()
                Items["Tooltip"].Instance.Position = UDim2.new(0, MouseLocation.X + 16, 0, MouseLocation.Y + 16)
        
                for _, V in Items do
                    if V.Instance:IsA("Frame") then V:Tween({BackgroundTransparency = 0})
                    elseif V.Instance:IsA("TextLabel") then V:Tween({TextTransparency = 0}) end
                end
        
                RenderStepped = RunService.RenderStepped:Connect(function()
                    local ML = UserInputService:GetMouseLocation()
                    Items["Tooltip"].Instance.Position = UDim2.new(0, ML.X + 16, 0, ML.Y + 16)
                end)
            end)
        
            Library:Connect(Object.MouseLeave, function()
                for _, V in Items do
                    if V.Instance:IsA("Frame") then V:Tween({BackgroundTransparency = 1})
                    elseif V.Instance:IsA("TextLabel") then V:Tween({TextTransparency = 1}) end
                end
        ...
        Library.Notify = function(Self, Name, Duration, Color)
            ...
            task.spawn(function()
                while task.wait(0.1) do 
                    ...
                    Items["Duration"].Instance.Text = Library:Round(Duration, 0.1) .. "s"
                end
            end)
            ...
            Library:Thread(function()
                ...
                Items["Liner"]:Tween(
                    ...
                    TweenInfo.new(OldDuration, Enum.EasingStyle.Linear, Enum.EasingDirection.Out)
                )
            ...
            function KeybindList:Add(Name)
                ...
                function NewKey:SetStatus(Bool)
                    if Bool then 
                        ...
                        NewCheck:ChangeItemTheme({ImageColor3 = "Inactive Text"})
                        NewText:ChangeItemTheme({TextColor3 = "Inactive Text"})
                        NewCheck:Tween({ImageColor3 = Library.Theme["Inactive Text"]})
                        NewText:Tween({TextColor3 = Library.Theme["Inactive Text"]})
                    end
                end
        ...
        Library.Watermark = function(Self, Params)
            ...
            local Watermark = { 
                Name = Params.Name or Params.name or "el damu",
            ...
            function Watermark:AddIcon(Icon)
            ...
            function Watermark:AddText(Text)
        ...
        Library.Window = function(Self, Params)
            ...
            local Window = {
                Name = Params.Name or Params.name or "cracked arm",
                TimeRemaining = Params.TimeRemaining or Params.timeRemaining or "0 days left",
            ...
            local Items = { } do 
                Items["MainFrame"] = Library:Create("Frame", {
                    Name = "\0",
                    Parent = Library.Holder.Instance,
                    AnchorPoint = IsMobile and Vector2.new(0, 0) or Vector2.new(0.5, 0.5),
                    Position = IsMobile and UDim2.new(0.5, 0, 0.3, 0) or UDim2.new(0.5, 70, 0.5, 0),
                    Size = UDim2.new(0, 700, 0, 495),
                    BorderSizePixel = 0,
                ...
                Library:Create("UICorner", {
                    ...
                    TopLeftRadius = UDim.new(0, 14),
                    TopRightRadius = UDim.new(0, 14),
                    BottomRightRadius = UDim.new(0, 14),
                    BottomLeftRadius = UDim.new(0, 14)
                })
                
                Items["SidebarButton"] = Library:Create("TextButton", {
                    Name = "\0",
                    FontFace = Library.Font,
                    TextSize = Library.FontSize,
                    Parent = Items["MainFrame"].Instance,
                ...
                Library:Create("UICorner", {
                    Name = "\0",
                    Parent = Items["SidebarButton"].Instance,
                    TopLeftRadius = UDim.new(0, 10),
                    TopRightRadius = UDim.new(0, 10),
                    BottomRightRadius = UDim.new(0, 10),
                    BottomLeftRadius = UDim.new(0, 10)
                ...
                Items["SideIcon"] = Library:Create("ImageLabel", {
                    Name = "\0",
                    Parent = Items["SidebarButton"].Instance,
                    AnchorPoint = Vector2.new(0.5, 0.5),
                    Image = "rbxassetid://79405219388592",
                    Position = UDim2.new(0.5, 0, 0.5, 0),
                ...
                Library:Create("UICorner", {
                    Name = "\0",
                    Parent = Items["SideIcon"].Instance,
                    TopLeftRadius = UDim.new(0, 10),
                    TopRightRadius = UDim.new(0, 10),
                    BottomRightRadius = UDim.new(0, 10),
                    BottomLeftRadius = UDim.new(0, 10)
                ...
                Items["TopLiner"] = Library:Create("Frame", {
                    Name = "\0",
                    Parent = Items["MainFrame"].Instance,
                    Position = UDim2.new(0, 60, 0, 23),
                    Size = UDim2.new(0, 2, 0, 15),
                    BorderSizePixel = 0,
                    BackgroundColor3 = Library.Theme["Section"]
                }):AddToTheme({BackgroundColor3 = 'Section'})

                Items["SearchBar"] = Library:Create("TextBox", {
                    Name = "\0",
                    FontFace = Library.Font,
                    TextSize = Library.FontSize,
                    Parent = Items["MainFrame"].Instance,
                ...
                Library:Create("Frame", {
                    ...
                    BorderSizePixel = 0,
                    BackgroundColor3 = Color3.fromRGB(27, 29, 35)
                }):AddToTheme({BackgroundColor3 = 'Liner'})
                ...
                Items["Title"] = Library:Create("TextLabel", {
                    ...
                    TextSize = 28,
                    Parent = Items["Top"].Instance,
                    TextColor3 = Color3.fromRGB(0, 177, 162),
                    Text = Window.Name,
                    AnchorPoint = Vector2.new(0.5, 0.5),
                    BackgroundTransparency = 1,
                    Position = UDim2.new(0.5, 0, 0.5, 0),
                ...
                Items["TimeRemaining"] = Library:Create("TextLabel", {
                    Name = "\0",
                    FontFace = Library.Font,
                    TextSize = Library.FontSize,
                    Parent = Items["Bottom"].Instance,
                    TextColor3 = Library.Theme["Inactive Text"],
                    Text = Window.TimeRemaining,
                    BorderSizePixel = 0,
                    BackgroundTransparency = 1,
                ...
                Items["TabLiner"] = Library:Create("Frame", {
                    Name = "\0",
                    Parent = Items["Side"].Instance,
                    AnchorPoint = Vector2.new(1, 0),
                    ...
                    BorderSizePixel = 0,
                    BackgroundColor3 = Color3.fromRGB(2, 177, 158)
                }):AddToTheme({BackgroundColor3 = 'Accent'})
                ...
                Items["SidebarButton"]:OnHover(function()
                    Items["SidebarButton"]:Tween({BackgroundColor3 = Library.Theme["Hovered Element"]})
                end, function()
                    Items["SidebarButton"]:Tween({BackgroundColor3 = Library.Theme["Element"]})
                end)
                ...
                function Window:RegisterSearchItem(Data)
                    ...
                    local SearchItem = {
                        ...
                        SubPage = Data.SubPage or nil,
                        Section = Data.Section or nil,
                        OriginalSize = nil,
                        Visible = true,
                    }
                ...
                function Window:RefreshSearch()
                    local Query = string.lower(string.gsub(tostring(Window.SearchQuery or ""), "%s+", ""))

                    if Query == "" then
                        for _, SecData in Library.SearchSections do
                            SecData.Instance.Visible = true
                        end
                        for _, Item in Library.SearchItems do
                    ...
                    for _, Item in Library.SearchItems do
                        local Matched = string.lower(string.gsub(tostring(Item.Name or ""), "%s+", "")):find(Query, 1, true) ~= nil
                        if Matched then
                            if Item.Section then
                                MatchedSections[Item.Section] = true
                            end
                            if not FirstSubPage and Item.SubPage then
                                FirstSubPage = Item.SubPage
                                FirstPage = Item.SubPage.Page
                            end
                        end
                    end
                    ...
                    if FirstSubPage and not FirstSubPage.Active then
                        FirstSubPage:Turn()
                    end
                    for _, SecData in Library.SearchSections do
                        SecData.Instance.Visible = MatchedSections[SecData.SectionObj] == true
                    end
                    for _, Item in Library.SearchItems do
                        local Holder = Item.Holder
                        if not Holder then continue end
                ...
                Library:Connect(Items["SearchBar"].Instance:GetPropertyChangedSignal("Text"), function()
                    Window.SearchQuery = Items["SearchBar"].Instance.Text
            ...
            function Window:SetSidebarOpen(Bool)
                ...
                Items["Side"]:FadeDescendants(Bool, function()
                    Debounce = false
                end)

                Items["Side"]:Tween({Size = UDim2.new(0, Bool and 210 or 0, 1, 0)})
            end

            Items["SidebarButton"]:Connect("MouseButton1Down", function()
                Window:SetSidebarOpen(not IsSidebarOpen)
            end)
        ...
        Library.Page = function(Self, Params)
            ...
            local Items = { } do 
                ...
                Items["Connector"] = Library:Create("Frame", {
                    Name = "\0",
                ...
                if Params.Hidden then
                    Items["Inactive"].Instance.Visible = false
                    Items["NewConnector"].Instance.Visible = false
                    Page.Page.Items["Connector"].Instance.Visible = false
                end
            ...
            Items["TabButton"]:OnHover(function()
                ...
                if Page.Active then return end
                Items["Icon"]:Tween({ImageColor3 = Library.Theme["Inactive Text"]})
            ...
            function Page:Turn()
                ...
                if Old then 
                    Old.Items["TabButton"]:Tween({BackgroundTransparency = 1})
                    Old.Items["SubPages"].Instance.Visible = false
    
                    Old.Items["Icon"]:ChangeItemTheme({ImageColor3 = "Inactive Text"})
                    Old.Items["Text"]:ChangeItemTheme({TextColor3 = "Inactive Text"})
                    
                    Old.Items["Icon"]:Tween({ImageColor3 = Library.Theme["Inactive Text"]})
                    Old.Items["Text"]:Tween({TextColor3 = Library.Theme["Inactive Text"]})

                    Old.Items["Page"]:Tween({Position = UDim2.new(0, -30, 0, 0)})
                ...
                Items["Page"].Instance.Position = UDim2.new(0, 30, 0, 0)
                ...
                Items["TabButton"]:Tween({BackgroundTransparency = 0})
        ...
        Library.SubPage = function(Self, Params)
            ...
            local Page = {
                Name = Params.Name or Params.name or "Page",
                IsOneColumn = Params.OneColumn or Params.onecolumn or false,
                IsLastTab = Params.LastTab or Params.lasttab or false,
            ...
            local Items = { } do 
                Items["Inactive"] = Library:Create("TextButton", {
                    ...
                    FontFace = Library.Font,
                    TextSize = Library.FontSize,
                    Parent = Page.Page.Items["Holder"].Instance,
                    TextColor3 = Library.Theme["Inactive Text"],
                    Text = Page.Name,
                    AutoButtonColor = false,
                    BackgroundTransparency = 1,
                ...
                Items["FullColumn"] = Library:Create("Frame", {
                    Name = "\0",
                ...
                Page.ColumnsData[0] = Items["FullColumn"]
                
                Items["TwoColumnHolder"] = Library:Create("Frame", {
                    Name = "\0",
                    Parent = Items["Page"].Instance,
                    BackgroundTransparency = 1,
                    Position = UDim2.new(0, 0, 0, 0),
                ...
                Library:Create("UIListLayout", {
                    Name = "\0",
                    Parent = Items["TwoColumnHolder"].Instance,
                    FillDirection = Enum.FillDirection.Horizontal,
                    HorizontalFlex = Enum.UIFlexAlignment.Fill,
                    Padding = UDim.new(0, 12),
                    SortOrder = Enum.SortOrder.LayoutOrder
                ...
                Items["FullColumn"].Instance:GetPropertyChangedSignal("AbsoluteSize"):Connect(function()
                    local fullH = Items["FullColumn"].Instance.AbsoluteSize.Y
                    Items["TwoColumnHolder"].Instance.Position = UDim2.new(0, 0, 0, fullH)
                    Items["TwoColumnHolder"].Instance.Size = UDim2.new(1, 0, 1, -fullH)
                end)
                ...
                Library:Create("UIPadding", {
                    ...
                    PaddingLeft = UDim.new(0, 12),
                    PaddingBottom = UDim.new(0, 12),
                    PaddingRight = UDim.new(0, Page.IsOneColumn and 12 or 0)
                })
                ...
                local Goal
                if IsMobile then
                    local ConnectorParent = Page.Page.Items["Connector"].Instance
                    local Scale = Library:GetScreenScale()
                    local Inactive = Items["Inactive"].Instance
                    local RelativeY = (Inactive.AbsolutePosition.Y - ConnectorParent.AbsolutePosition.Y) / Scale
                    local InactiveHeight = Inactive.AbsoluteSize.Y / Scale
                    local Y = RelativeY + (InactiveHeight / 5) - (20 / 2) + 5
                    if Page.IsLastTab then
                        Y = RelativeY + (InactiveHeight / 1.5) - (20 / 2) + (14 / Scale) - 8
                    end
                    Goal = UDim2.fromOffset(-1, Y)
                else
                    local SubPagesParent = Page.Page.Items["SubPages"].Instance
                    local ParentAbsPos = SubPagesParent.AbsolutePosition
                    local RelativePos = Items["Inactive"].Instance.AbsolutePosition - ParentAbsPos
                    Goal = UDim2.fromOffset(-1, RelativePos.Y + (Items["Inactive"].Instance.AbsoluteSize.Y / 5) - (12 / 2))
                    if Page.IsLastTab then
                        Goal = UDim2.fromOffset(-1, RelativePos.Y + (Items["Inactive"].Instance.AbsoluteSize.Y / 2) - (12 / 2) + 14)
                    end
                end

                Items["NewConnector"] = Library:Create("ImageLabel", {
                    Name = "\0",
                    Parent = Page.Page.Items["Connector"].Instance,
                    ImageColor3 = Color3.fromRGB(70, 73, 78),
                    AnchorPoint = Vector2.new(0, Page.IsLastTab and 1 or 0),
                    Image = "rbxassetid://92517825248601",
                    BackgroundTransparency = 1,
                    Rotation = -7,
                    Position = Goal,
        ...
        Library.Section = function(Self, Params)
            ...
            local Items = { } do 
                local OneColumn = Params.OneColumn or Params.oneColumn or false
                local SectionParent = (OneColumn and Section.Page.ColumnsData[0]) or Section.Page.ColumnsData[Section.Side]
                
                Items["Section"] = Library:Create("Frame", {
                    Name = "\0",
                    Parent = SectionParent.Instance,
                    BackgroundTransparency = 1,
                    Size = UDim2.new(1, 0, 0, 0),
                    BorderSizePixel = 0,
                    AutomaticSize = Enum.AutomaticSize.Y
                ...
                local function RefreshDividers()
                    local children = {}
                    for _, c in Items["Content"].Instance:GetChildren() do
                    ...
                    for i, child in ipairs(children) do
                        for _, desc in child:GetChildren() do
                            if desc:GetAttribute("IsLiner") then
                                desc.Visible = i ~= #children
                                break
                            end
                        end
                    end
                ...
                Items["Content"].Instance.ChildAdded:Connect(function()
                    task.defer(RefreshDividers)
                end)
                Items["Content"].Instance.ChildRemoved:Connect(RefreshDividers)

                Section.Items = Items
            end
    
            table.insert(Library.SearchSections, {
                SectionObj = Section,
                Instance = Items["Section"].Instance
            })
        ...
        Library.Toggle = function(Self, Params)
            ...
            local Items = { } do 
                ...
                Items["Check"] = Library:Create("ImageLabel", {
                    ...
                    ImageTransparency = 1,
                    AnchorPoint = Vector2.new(0.5, 0.5),
                    Image = "rbxassetid://89420780246818",
                    BackgroundTransparency = 1,
                    Position = UDim2.new(0.5, 0, 0.5, 0),
                    Size = UDim2.new(0, 14, 0, 14),
                    BorderSizePixel = 0
                ...
                Items["Liner"].Instance:SetAttribute("IsLiner", true)           
            ...
            function Toggle:Set(Bool)
                ...
                if Bool then 
                    Items["Check"]:Tween({ImageTransparency = 0})
                    Items["Inline"]:Tween({Size = UDim2.new(1, 0, 1, 0), BackgroundTransparency = 0})
                    Items["Text"]:ChangeItemTheme({TextColor3 = "Text"})
                    Items["Text"]:Tween({TextColor3 = Library.Theme.Text})
                else
                    Items["Check"]:Tween({ImageTransparency = 1})
                    Items["Inline"]:Tween({Size = UDim2.new(0, 0, 0, 0), BackgroundTransparency = 1})
            ...
            function Toggle:Settings(Size)
                ...
                local SettingsItems = { } do
                    ...
                    SettingsItems["Content"] = Library:Create("ScrollingFrame", {
                        ...
                        BorderSizePixel = 0,
                        CanvasSize = UDim2.new(0, 0, 0, 0),
                        ScrollBarImageColor3 = Library.Theme["Inactive Text"],
                    ...
                    }):AddToTheme({ScrollBarImageColor3 = 'Inactive Text'})
        ...
        Library.Slider = function(Self, Params)
            ...
            local Items = { } do 
                ...
                Items["DraggerStroke"] = Library:Create("UIStroke", {
                    Name = "\0",
                    Parent = Items["Dragger"].Instance,
                    ApplyStrokeMode = Enum.ApplyStrokeMode.Border,
                    Color = Library.Theme["Section"],
            ...
            Items["RealSlider"]:Connect("InputBegan", function(Input)
                if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
                    Slider.Sliding = true
                    Items["Dragger"]:Tween({BackgroundTransparency = 0})
                    Items["DraggerStroke"]:Tween({Transparency = 0})
                    ...
                    InputChanged = Input.Changed:Connect(function()
                        if Input.UserInputState == Enum.UserInputState.End then
                            ...
                            Items["Dragger"]:Tween({BackgroundTransparency = 1})
                            Items["DraggerStroke"]:Tween({Transparency = 1})
        ...
        Library.Dropdown = function(Self, Params)
            ...
            local Items = { } do 
                ...
                Items["OptionHolder"] = Library:Create("TextButton", {
                    ...
                    Position = UDim2.new(0, 1057, 0, 149),
                    BorderSizePixel = 0,
                    AutomaticSize = Enum.AutomaticSize.Y,
                    BackgroundColor3 = Library.Theme["Inline"]
                }):AddToTheme({BackgroundColor3 = 'Inline'})
                ...
                if Params.SearchBarEnabled or Params.searchBarEnabled then
                    ...
                    Library:Connect(Items["SearchInput"].Instance:GetPropertyChangedSignal("Text"), function()
                        local Query = Items["SearchInput"].Instance.Text:lower()
                        for OptionName, OptionData in Dropdown.Options do
                            local Matched = Query == "" or OptionName:lower():find(Query, 1, true) ~= nil
                            local Button = OptionData.Button.Instance
                            local Check = OptionData.Check.Instance
                    
                            if Matched and not Button.Visible then
                                Button.Size = UDim2.new(1, 0, 0, 0)
                                Button.TextTransparency = 1
                                Check.ImageTransparency = 1
                                Button.Visible = true
                                OptionData.Button:Tween({TextTransparency = 0})
                                OptionData.Check:Tween({ImageTransparency = 0})
                                Library:Tween({Size = UDim2.new(1, 0, 0, 20)}, nil, Button)
                            elseif not Matched and Button.Visible then
                                OptionData.Button:Tween({TextTransparency = 1})
                                OptionData.Check:Tween({ImageTransparency = 1})
                                Library:Tween({Size = UDim2.new(1, 0, 0, 0)}, nil, Button)
                                local Token = (OptionData._searchToken or 0) + 1
                                OptionData._searchToken = Token
                                task.delay(Library.Animation.Time + 0.05, function()
                                    if OptionData._searchToken == Token then
            ...
            function Dropdown:Add(Value)
                ...
                local OptionCheck = Library:Create("ImageLabel", {
                    ...
                    Image = "rbxassetid://114461119629011",
                    BackgroundTransparency = 1,
                    Position = UDim2.new(1, 25, 0.5, 0), --starts off screen
                    Size = UDim2.new(0, 14, 0, 14),
                    BorderSizePixel = 0
            ...
            function Dropdown:SetOpen(Bool)
                ...
                if Dropdown.IsOpen then 
                    ...
                    OptionHolder.Size = UDim2.new(0, RealDropdown.AbsoluteSize.X / Scale, 0, Dropdown.MaxSize)
                    OptionHolder.Parent = Library.Holder.Instance
                    Items["OptionHolder"]:Tween({Position = Library:PopupPosition(RealDropdown, OptionHolder, 10)})
                ...
                if Items["SearchInput"] then
                    Items["SearchInput"].Instance.Text = ""
                    for _, OptionData in Dropdown.Options do
                        local Button = OptionData.Button.Instance
                        OptionData._searchToken = (OptionData._searchToken or 0) + 1
                        Button.Visible = true
                        Button.Size = UDim2.new(1, 0, 0, 20)
                        Button.TextTransparency = 0
                        OptionData.Check.Instance.ImageTransparency = 0
                    end
                end
        ...
        Library.InitSettings = function(Self, Input)
            local SubPage
        
            if Input.ColumnsData then
                SubPage = Input
            else
                SubPage = Input:SubPage({ Name = "General", LastTab = true, Hidden = true })
            end
            local ConfigsSection = SubPage:Section({Name = "Configs", Side = 1})
            local ThemingSection = SubPage:Section({Name = "Theming", Side = 2})
            ...
            do
                ...
                local ConfigsDropdown = ConfigsSection:Dropdown({
                    ...
                    Callback = function(Value)
                        ...
                        if Flags["AutoLoad"] and Value and Value ~= "" then
                            writefile(AutoLoadFile, Value)
                        end
                    end
                })
                ...
                ConfigsSection:Label({Name = "UI Bind"}):Keybind({
                    Flag = "UIBind",
                    Mode = "Toggle",
                ...
                ConfigsSection:Toggle({
                    ...
                    Callback = function(Value)
                        ...
                        local target = (type(ConfigSelected) == "string" and ConfigSelected ~= "" and ConfigSelected)
                            or (type(ConfigsDropdown.Value) == "string" and ConfigsDropdown.Value ~= "" and ConfigsDropdown.Value)
                        if target then writefile(AutoLoadFile, target) end
                    end
                })

                if isfile(AutoLoadFile) then
                    local AutoName = readfile(AutoLoadFile)
                    local AutoPath = ConfigsFolder .. AutoName .. ".json"
                    if isfile(AutoPath) then
                        Library:LoadConfig(readfile(AutoPath))
                        ConfigsDropdown:Set(AutoName)
                        ConfigSelected = AutoName
                    end
                end
            end
        ...
        Library.Init = function(Self)
            local SettingsPage = Self:Page({Name = "Settings", Icon = "rbxassetid://101163724569815"})
            local GeneralSubPage = SettingsPage:SubPage({Name = "General", LastTab = true})
            Library:InitSettings(Self, GeneralSubPage)
        end
    end
end
